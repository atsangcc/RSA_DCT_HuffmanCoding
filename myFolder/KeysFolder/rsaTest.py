#The python file is modified based on the following original code
...
def verify(receivedHashed, message):
    ...
    return receivedHashed == ourHashed
...
def main():
    ...
    # with open('aText.txt') as txtHuffmanCode :
    #     contentsHuffmanCode = txtHuffmanCode.read()
        #print(contentsHuffmanCode)
    message1 = "contentsHuffmanCode"
    print("txtHuffmanCode inputed")

    hashed = hashFunction(message1)
