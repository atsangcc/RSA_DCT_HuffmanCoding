...
def descomprimir(hEncoderPath,huffmanCodeOnly):
...
# 			break
	...
	#print(bit_string)
	TextEncode =huffmanCodeOnly# quitar_bit_padding()
	#print(TextEncode)
	# aTextFile = open("afterText.txt","w")
	# aTextFile.write(TextEncode)
	# aTextFile.close() 
	TextDescomprimido = decodificarTexto(TextEncode,hEncoderPath)
	write_file(TextDescomprimido)
	recoveredDCT=TextDescomprimido
	return recoveredDCT
